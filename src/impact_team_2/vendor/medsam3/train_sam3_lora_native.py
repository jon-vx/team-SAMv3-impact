...
# Resolve the BPE vocab file inside the installed `sam3` package so this trainer
# can be invoked from any working directory (the upstream script assumes a cwd of
# the MedSAM3 repo root).
import sam3 as _sam3_pkg
_BPE_PATH = str(Path(_sam3_pkg.__file__).parent / "assets" / "bpe_simple_vocab_16e6.txt.gz")
